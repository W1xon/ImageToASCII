(function () {
  ...
  function initAsciiBg() {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const maxOpacity = 0.25 + depth * 0.55;
      ...
      if (depth > 0.5) {
        const glowRadius = Math.floor((depth - 0.5) * 12);
      ...
      // Анимация движения — плавный дрейф
      span.animate([
      ...
      // Анимация прозрачности — плавное появление и растворение
      span.animate([
        { opacity: 0 },
